...
export default function NotesScreenDetails() {
  ...
  const [notePrice, setNotePrice] = useState(params.price);
    ...
    >
      <View style={{ flexDirection: "row", alignItems: "center" }}>
        <TouchableOpacity onPress={() => navigation.goBack()}>
          <FontAwesome name={"arrow-left"} size={50} color={"#35251A"} />
        </TouchableOpacity>
        ...
        >
          <FontAwesome
            name={"pencil"}
            size={50}
            color={editable ? "forestgreen" : "#35251A"}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          style={{ marginLeft: 15 }}
        >
          <FontAwesome name={"trash"} size={50} color={"#35251A"} />
        </TouchableOpacity>
      </View>
      <TextInput
